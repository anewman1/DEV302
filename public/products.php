    ...
    <div class="products clearfix">
        ...
        while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
            ...
            <div class="col-lg-4 col-sm-4 hero-feature text-center">
                <div class="thumbnail">
                    <a style="overflow: hidden; position: relative;" href="productDetail.php?alias=<?= $row['id'] . "-" . $alias ?>" class="link-p">
                    ...
                    <div class="caption prod-caption">
                        <h4><a href="productDetail.php?alias=<?= $row['id'] . "-" . $alias ?>"><?= $row['name'] ?></a></h4>
