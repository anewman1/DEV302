...
<head>
    ...
    <link href="css/pwdwidget.css" rel="stylesheet">
</head>
<body>
	<header>
	    <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            ?>
                            <li class="blk"><a href="settings.php" style="color:#333!important;"><span class="glyphicon glyphicon-cog"></span> Settings</a></li>
                            <li class="divider"></li>
